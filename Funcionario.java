public class Funcionario{
    ...
    private static int matriculaEstatica = 1;;

    public Funcionario(String matr, String nome, double salBruto) {
        this.matricula = matr;
        this.nome = nome;
        this.salarioBruto = salBruto;
    }

    Funcionario(String nome, double salBruto){
        this.nome = nome;
        this.salarioBruto = salBruto;
        this.matricula = "M: " + matriculaEstatica++;
    }
